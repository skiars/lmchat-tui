...
class FixedFontParser p where
  ...
  splitLine :: p
            ...
            -> VisibleLine (BreakType p)   -- ^ Line to split.
            -> (VisibleLine (BreakType p),
                VisibleLine (BreakType p)) -- ^ New lines at @(bottom,top)@ of previous/next paragraphs.
